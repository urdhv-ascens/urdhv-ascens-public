...
export function CourseEntryModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="relative w-full max-w-lg bg-zinc-950 border border-zinc-850 rounded-2xl p-6 sm:p-8 shadow-2xl overflow-y-auto max-h-[90vh]">
        <button
          onClick={onClose}
  ...
  <form onSubmit={handleSubmit} className="space-y-4">
    ...
    <div className="grid grid-cols-2 gap-3">
      <button
        ...
        className={`p-3 rounded-xl border text-left transition-all flex flex-col justify-between ${courseSelected === 'students-ai'
      ...
      <button
        ...
        className={`p-3 rounded-xl border text-left transition-all flex flex-col justify-between ${courseSelected === 'teachers-ai'
            ? 'bg-emerald-500/15 border-emerald-500/40 text-white'
            : 'bg-zinc-900/60 border-zinc-800 text-zinc-400 hover:border-zinc-700'
          }`}
      >
